...
<body>
<div class="container">
<div class="row" style="background-color:lightblue; color:balck;">
 <button class="btn btn-primary hidden-print" style="float:right" id="btn" onclick="myFunction()"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
 
       <h2 style="text-align:center;">Turbela Fruits Company</h2>
