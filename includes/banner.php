<div class="agileits"> 
		<div class="container">
			<div class="banner2" style="height:300px;"> 
			<!--	<h2>Swat Fruits Company</h2>
				<div class="w3lsmore">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1500px;height:600px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/full-width/peach.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/full-width/swat3.jpg" />
            </div>
			<div>
                <img data-u="image" src="img/full-width/swat4.jpg" />
            </div>
			<div>
                <img data-u="image" src="img/full-width/swat9.jpg" />
            </div>
			            <div>
                <img data-u="image" src="img/full-width/peach.jpg" />
            </div>
